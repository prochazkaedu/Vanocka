...
public class StoryIntro {
	private static String[] storyText = {
		...
		"",
		"Sněhulák Vás snažně prosí, ať mu tu jeho mrkev",
		"najdete. Banditovo mrkvové doupě se nachází",
		"uprostřed bludiště, před kterým právě stojíte.",
		"",
		"Pokud sněhulákovi pomůžete a najdete mu mrkev",
		"bude šťastný a možná Vám dá dárek. :)",
		"",
